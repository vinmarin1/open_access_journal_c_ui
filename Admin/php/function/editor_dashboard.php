...
include 'dbcon.php';
    if (!function_exists('get_journalsubmission')) {
        function get_journalsubmission($journal_id = null)
        {
            ...
            if ($pdo) {
                try {
                    ...
                    if (!empty($journal_id)) {
                        $query .= " WHERE j.journal_id = :journal_id";
                    }
    ...
    if (!function_exists('get_submissioncomparison')) {
        function get_submissioncomparison($journal_id = null) {
            $pdo = connect_to_database();
            ...
            if ($pdo) {
                try {
                    ...
                    if (!empty($journal_id)) {
                        $query .= " AND a.journal_id = :journal_id";
                    }
    ...
    if (!function_exists('get_publishedcount')) {
        function get_publishedcount($journal_id = null) {
            $pdo = connect_to_database();
    ...
    if (!function_exists('get_ongoingcount')) {
        function get_ongoingcount($journal_id = null) {
            $pdo = connect_to_database();
