...
$articlelist = get_archive_article_list($monthval, $yearval);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
                        ...
                        if (isset($articlelist['articlelist']) && count($articlelist['articlelist']) > 0) {
                            foreach ($articlelist['articlelist'] as $articlelistval) {
                                ...
                                <tr data-toggle="modal" data-target="">
                                    ...
                                    <td width="5%"><?php echo $articlelistval->archive_date; ?></td>
                                </tr>
                                <?php
                            }
                        }
    ...
    <script>
        ...
        function doset(yearval, monthval) {
            $('#sloading').show();
            var url = "totalarchive.php?m=" + monthval + '&y=' + yearval;
        ...
        function exportToExcel() {
            ...
            var filename = 'archive_articles_' + yearval + '_' + monthName + '.xlsx';
