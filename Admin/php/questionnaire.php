                    ...
                    <tbody>
                        <?php foreach ($answer_list as $answer_listval): ?>
                            <tr>
                                ...
                                <td width="10%">
                                    <button type="button" class="btn btn-success" title="Update" onclick="updateModal(<?php echo $answer_listval->reviewer_questionnaire_id; ?>)"><i class="bx bx-edit-alt"></i></button>
                                    <button type="button" class="btn btn-danger" title="Delete" onclick="archiveJournal(<?php echo $answer_listval->reviewer_questionnaire_id; ?>, '<?php echo $answer_listval->question; ?>')"><i class="bx bx-trash"></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>    
...
<style>
    ...
    <div class="modal fade" id="archiveModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="archiveModalTitle">Delete Question</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <h5 class="modal-title" id="modalToggleLabel">Are you sure you want to delete this question?</h5>
                        <p id="questionInfo"></p>
                    </div>
                </div>
                <div class="modal-footer">
