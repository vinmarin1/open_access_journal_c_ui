...
<body>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4" style="display: flex; justify-content: space-between; align-items: baseline;">
            Others / <a href="../php/reportlist.php"> <span class="text-muted fw-light">&nbsp;Report /</span></a>&nbsp; Donation Report
        ...
        <div class="row mb-2">
                ...
                <form id="reportForm">
                    <select class="form-select" onchange="doset(this.value, monthval.value)" name="yearval" id="yearval">
                        ...
                        for ($x = 1; $x <= 6; $x++) {
                            $yr = $yr - 1;
                        ?>
                            <option value="<?php echo $yr; ?>" <?php if ($_GET['y'] == $yr) {
                                                                    echo "selected";
                                                                } ?>>
                                <?php echo $yr; ?>
                            </option>
            ...
            <div class="col-md-6 mb-2">
                <select class="form-select" onchange="doset(yearval.value, this.value)" name="monthval" id="monthval">
                    ...
                    ?>
                        <option value="<?php echo $key; ?>" <?php if ($_GET['m'] == $key) {
                                                                echo "selected";
                                                            } ?>>
                            <?php echo $value; ?>
                        </option>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            var ws = XLSX.utils.aoa_to_sheet([
                ["ID", "Name", "Email", "Amount", "Received Date"]
            ].concat(wsData));
