...
$articlelist = get_allmtd_article_list($monthval, $yearval, $statusval);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        Others / <a href="../php/reportlist.php"> <span class="text-muted fw-light">&nbsp;Report /</span></a>&nbsp; Article List MTD
        ...
        <div class="row mb-2">
            <div class="col-md-6 mb-2">
                ...
                <ul class="nav nav-tabs mb-3" id="statusTabs">
                    <li class="nav-item">
                        <a class="nav-link active" id="MTD" data-status="">MTD</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="YTD" data-status="" onclick="showLoading(); window.location.href='allarticlereportytd.php?y=' + new Date().getFullYear() + '&s=10';">YTD</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-6 mb-2">
                <!-- Removed duplicate form tag -->
                <select class="form-select" onchange="doset(yearval.value, monthval.value, this.value)" name="statusval" id="statusval">
                    <?php
                    $statusOptions = [
                        '10'  => 'All',
                        '0' => 'Archive',
            ...
            <div class="col-md-6 mb-2">
                ...
                <select class="form-select" onchange="doset(yearval.value, this.value)" name="monthval" id="monthval">
                    ...
                    foreach ($months as $key => $value) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo ($monthval == $key) ? 'selected' : ''; ?>>
                            <?php echo $value; ?>
                        </option>
                        <?php
                    }
...
<script>
    ...
    function doset(yearval, monthval) {
            ...
            $('#sloading').show();
            var url = "allarticlereportmtd.php?m=" + monthval + '&y=' + yearval + '&s=' + statusval;
        ...
        function exportToExcel() {
            ...
            var filename = statusLabel + '_articles_' + yearval + '_' + monthName + '.xlsx';
