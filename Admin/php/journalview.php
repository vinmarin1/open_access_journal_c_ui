                    ...
                    foreach ($journallist as $journallistval) {
                        ...
                        <div class="col-md-6">
                            <div class="card mb-3">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="card-img card-img-left img-fluid" src="http://monorbeta-001-site1.btempurl.com/journaldata/journalimage/<?php echo $journallistval->image; ?>" alt="Card image" />
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
