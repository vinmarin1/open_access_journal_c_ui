...
<div class="container-fluid dev-team">
    ...
    <div class="row">
    <div class="col-md-1" style="margin-left:-15px"> <!------ blank space -------> </div>
        <div class="col-md-10">
            <h3>HEADS</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-1" style="margin-left:-80px"> <!------ blank space -------> </div>
            <div class="col-md-10">
                <h3 style="color: #115272;">PROGRAMMERS</h3>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-2 d-flex align-items-center justify-content-center">
            <div class="mt-2 mb-2 members-content text-center">
                ...
                <div class="row soc-links" >
                    <div class="col-md-2 col-2"></div>
                    <div class="col-md-2 col-2"><a href="https://www.facebook.com/avilamon024"><i class="fab fa-facebook-f" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="mailto:moncedricavila@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="currentColor" d="M32 6v20c0 1.135-.865 2-2 2h-2V9.849l-12 8.62l-12-8.62V28H2c-1.135 0-2-.865-2-2V6c0-.568.214-1.068.573-1.422A1.973 1.973 0 0 1 2 4h.667L16 13.667L29.333 4H30c.568 0 1.068.214 1.427.578c.359.354.573.854.573 1.422"/></svg></a></div>

                    <div class="col-md-2 col-2"><a href="https://www.instagram.com/cedricavila/"><i class="fa-brands fa-instagram" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="https://www.linkedin.com/in/mon-cedric-avila-a515ab20b/"><i class="fa-brands fa-linkedin" style="color: blue;"></a></i></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-2 d-flex align-items-center justify-content-center">
            <div class="mt-2 mb-2 members-content text-center">
                ...
                <div class="row soc-links" >
                    <div class="col-md-2 col-2"></div>
                    <div class="col-md-2 col-2"><a href="https://web.facebook.com/Vinmarin.08"><i class="fab fa-facebook-f" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="mailto:gozo.marvin23@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="currentColor" d="M32 6v20c0 1.135-.865 2-2 2h-2V9.849l-12 8.62l-12-8.62V28H2c-1.135 0-2-.865-2-2V6c0-.568.214-1.068.573-1.422A1.973 1.973 0 0 1 2 4h.667L16 13.667L29.333 4H30c.568 0 1.068.214 1.427.578c.359.354.573.854.573 1.422"/></svg></a></div>

                    <div class="col-md-2 col-2"><a href="https://www.instagram.com/vinmarin_/"><i class="fa-brands fa-instagram" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="https://www.linkedin.com/in/marvin-gozo-23a86028a/"><i class="fa-brands fa-linkedin" style="color: blue;"></i></a></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-2 d-flex align-items-center justify-content-center">
            <div class="mt-2 mb-2 members-content text-center">
                ...
                <div class="row soc-links" >
                <div class="col-md-2 col-2"></div>
                    <div class="col-md-2 col-2"><a href="https://www.facebook.com/zion459"><i class="fab fa-facebook-f" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="mailto:stephenzionheraldo@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="currentColor" d="M32 6v20c0 1.135-.865 2-2 2h-2V9.849l-12 8.62l-12-8.62V28H2c-1.135 0-2-.865-2-2V6c0-.568.214-1.068.573-1.422A1.973 1.973 0 0 1 2 4h.667L16 13.667L29.333 4H30c.568 0 1.068.214 1.427.578c.359.354.573.854.573 1.422"/></svg></a></div>

                    <div class="col-md-2 col-2"><a href=""><i class="fa-brands fa-instagram" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="https://www.linkedin.com/in/stephen-zion-heraldo-2a90a2210/"><i class="fa-brands fa-linkedin" style="color: blue;"></a></i></div>
                </div>
            </div>
        </div>   
        ...
        <div class="col-md-3 mb-2 d-flex align-items-center justify-content-center">
            <div class="mt-2 mb-2 members-content text-center">
                ...
                <div class="row soc-links" >
                <div class="col-md-2 col-2"></div>
                    <div class="col-md-2 col-2"><a href="https://www.facebook.com/dharren13/"><i class="fab fa-facebook-f" style="color: blue;"></i></a></div>

                    <div class="col-md-2 col-2"><a href="mailto:dharren.sanchez023@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="currentColor" d="M32 6v20c0 1.135-.865 2-2 2h-2V9.849l-12 8.62l-12-8.62V28H2c-1.135 0-2-.865-2-2V6c0-.568.214-1.068.573-1.422A1.973 1.973 0 0 1 2 4h.667L16 13.667L29.333 4H30c.568 0 1.068.214 1.427.578c.359.354.573.854.573 1.422"/></svg></a></div>
    ...
    <div class="row">
        <div class="col-md-1" style="margin-left:-80px"> <!------ blank space -------> </div>
            <div class="col-md-10">
                <h3 style="color: #115272;">SYSTEM ANALYST</h3>
            </div>
        </div>
    </div>
