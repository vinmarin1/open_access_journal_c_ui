        ...
        <div class="container-fluid">
            <div class="row mt-5">
                ...
                <div class="col-md-10">
                    ...
                    <span>
                        <p>We believe in the power of open access to knowledge and the transformative impact it can have on education, research, and global progress. By contributing to our open-access journal system, you're helping us break down barriers to information and make scholarly content freely available to everyone, anywhere.</p>
                    </Span>
                </div>
                            ...
                            <div class="tab" id="donateSum">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-6 col-6 text-end">
                                        <span>
                                            <h4 style="font-weight: bold;">PHP <?php echo isset($_GET['amount']) ? $_GET['amount'] : ''; ?></h4>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6 col-6">
                                        <span>
                                            <h4 style="font-weight: bold;">First Name</h4>
                                        </span>
                                    </div>
                                    <div class="col-md-6 col-6 text-end">
                                        <span>
                                            <h5><?php echo isset($_GET['payer_firstname']) ? $_GET['payer_firstname'] : ''; ?></h5>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6 col-6">
                                        <span>
                                            <h4 style="font-weight: bold;">Last Name</h4>
                                        </span>
                                    </div>
                                    <div class="col-md-6 col-6 text-end">
                                        <span>
                                            <h5><?php echo isset($_GET['payer_lastname']) ? $_GET['payer_lastname'] : ''; ?></h5>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-7 col-7 text-end">
                                        <span>
                                            <h5><?php echo isset($_GET['payer_email']) ? $_GET['payer_email'] : ''; ?></h5>
                                        </span>
                                    </div>
                                </div>
