...
<body>
    <form id="form" method="POST" action="recover_account_functions.php">
        ...
        <div id="firstStep">
            ...
            <div class="input-group mb-3" id="inputFields">
                ...
                <button type="submit" class="btn btn-primary btn-md" id="sendBtn" disabled>
        ...
        <div id="secondStep">
            ...
            <div class="input-group mb-3" id="inputFields1">
                <input type="text" class="form-control"  aria-describedby="basic-addon1" name="otp" id="otp">
                <!-- <button type="submit" class="btn btn-primary btn-md" id="otpBtn">Confirm OTP</button> -->
            </div>
        </div>
