...
<div class="main-container">
    <div class="content-over">
        ...
        <button class="btn btn-primary btn-md" id="btn1" onclick="window.location.href='author-dashboard.php'">As Author</button>
        <button class="btn btn-primary btn-md" id="btn2" onclick="window.location.href='reviewer-dashboard.php'">As Reviewer</button>
</div>
