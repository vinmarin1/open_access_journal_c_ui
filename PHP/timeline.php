...
<form id="multiSForm" method="POST" action="../PHP/submit.php" >
  ...
  <div class="tab" id="tab1">
    ...
    <h6 style="color: var(--main, #0858A4)">Indicate that this submission is ready to be considered by this journal by checking off the following (comments to the editor can be added below).</h6>
...
<!-- <p class="line">_____________________________________________________________</p> -->
  ...
  <h6 style="color: var(--main, #0858A4)">Authors who publish with this journal also agree to the following terms: 
  <p class="h6" style="color: var(--main, #0858A4); margin-top: 20px">Authors are able to enter into separate, additional contractual arrangements for the non-exclusive distribution of the journal's published version of the work (e.g., post it to an institutional repository or publish it in a book), with an acknowledgement of its initial publication in this journal. 
</p>
<p class="h6" style="color: var(--main, #0858A4); margin-top: 20px">
...
<div class="form-check">
  ...
  <div class="tab">
  <h5 class="title">Submission Checklist</h5>
  <h6 style="color: var(--main, #0858A4)">Please provide the following details to help us manage your submission in our system.</h6>
  ...
  <label class="form-check-label" for="flexRadioDefault1" style="color: var(--main, #0858A4); font-family: Times New Roman;">
    The Gavel
  </label>
</div>
<div class="form-check category-type" style="margin-left: 10px">
  <input class="form-check-input radio-select" type="radio" name="category" id="flexRadioDefault2" value="">
  <label class="form-check-label" for="flexRadioDefault2" style="color: var(--main, #0858A4); font-family: Times New Roman;">
   The Star
  </label>
</div>
<div class="form-check category-type"  style="margin-left: 10px">
  <input class="form-check-input radio-select" type="radio" name="category" id="flexRadioDefault3" value="">
  <label class="form-check-label" for="flexRadioDefault3" style="color: var(--main, #0858A4); font-family: Times New Roman;">
   The Lamp
  </label>
</div>
...
?>
 ...
 <h6 style="color: var(--main, #0858A4)">Please provide the following details to help our editorial team manage your submission.</h6>
 <div class="input-group">
