...
function handleFileUpload($files, $contributor, $author_id, $volume, $privacy, $formattedDate, $title, $category, $abstract, $subject_areas, $keywords, $reference, $comment, $coAuthors, $primaryContacts, $firstNameC, $lastNameC, $orcidsC, $emailsC, $firstName, $lastName, $orc_idAuthor, $email, $editor, $translator)
{
