...
<form action="ex_submit_conadmin1.php" method="post" id="form" enctype="multipart/form-data" id="submit-form">
...
<div class="tab-content" id="myTabContent">
  ...
  <div class="descript-1 pt-3">
    <div class=" " id="checkList-1">
      <label for="check-1" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-1" name="" checked>
    ...
    <div class="" id="checkList-2">
      <label for="check-2" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-2" checked>
    ...
    <div class="" id="checkList-3">
      <label for="check-3" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-3" checked>
    ...
    <div class="" id="checkList-4">
      <label for="check-4" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-4" checked>
    ...
    <div class="" id="checkList-6">
      <label for="check-6" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-6" checked>
    ...
    <div class="" id="checkList-7">
      <label for="check-7" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-7" checked>
    ...
    <div class="" id="checkList-8">
      <label for="check-8" class="checkItem">
        <input type="checkbox" class="my-checkbox" id="check-8" checked>
  ...
  <label for="check" class="checkItem">
    <input type="checkbox" class="my-checkbox" id="check" name="check" value="1" checked>
...
<script src="../JS/ex_submitadmin.js"></script>  
