...
<body>
    ...
    <main class="d-flex gap-2">
        ...
        <div id="frequently-asked-questions-container" style="width:90%" class="mt-4"> 
            <div class="content">
                <div class="s-1 category w-100">
                    <h3>
    ...
    <div class="main" id="tutorial-on-publication-container" style="display: none;">
        ...
        <div class="category w-100">
            <div class="s-1">
                <p>Welcome to our Publication Tutorial for QCUJ. This guide simplifies the process, 
            ...
            <div class="s-2">
                ...
                <ul type="circle">
                    ...
                    <li>Our editors will investigate any claims of research misconduct in publication. Proper
                        ...
                        When publishing with the QCUJ, authors are expected to follow the most
