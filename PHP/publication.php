    ...
    <div class="container-fluid pub-container mb-3">
        <div class="journal-title">
            ...
            <div class="pic-border">
                <img class="img-fluid" src="../images/Gavel.png" alt="">
            </div>
        </div>
        ...
        <div class="journal-details">
            ...
            <div class="other-info">
                ...
                <div class="edit-board">
                    ...
                    <ul>
                        ...
                        <li>Dr. Isagani Tano</li>
                        <li>Prof. Maria Aura Impang</li>
                        <li>Engr. Jeffrey Cacho</li>
                        <li>Engr. Leonard Catchillar</li>
                        <li>Prof. Randel Estacio</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="fluid-container">
                ...
                <p class="h6">Blockchain Beyond Cyptocurrency: Transforming Industries with Distributed Ledger Technology</p>
                    ...
                    <button class="btn btn-primary btn-md btn-article"  style=" border: 2px #0858a4 solid;
