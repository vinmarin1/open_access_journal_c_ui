  ...
  data.forEach((item) => {
        ...
        <div class="article-title">
            ...
            <div class="after-title">
                ...
                <div class="volume">
                    ...
                    <p href="./all-issues??issue=0"><a class="text-muted" href="./all-issues.php?issue=0">-</a></p>
                </div>
            </div>
        </div>
      </div>
    ...
    if (epubBtn) {
      epubBtn.addEventListener("click", () => {
        try{
          Swal.fire({
            html: '<h4 style="color: var(--main, #0858A4); font-family: font-family: Arial, Helvetica, sans-serif">Successfully downloaded.</h4>',
            icon: 'success',
          })
